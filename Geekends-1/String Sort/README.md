Sunil is given a simple task of sorting strings. He need to sort strings according to the ith character in strings.Given multiple strings and multiple positions, print the sorted strings accordingly.
